---
title: "Maimonides, the Spinoza that the Islamic World Never Had?"
lang: en
...
**Canonical turning point: al-Ghazālī**
Al-Ghazālī, in his critique of philosophers (*Tahāfut al-falāsifa*), specifically attacks the idea that natural causes **necessitate** their effects, because, according to him, this would limit divine intervention (miracles) and threaten the uniqueness of divine action.
...
**Challenge for “Maimonides → Spinoza”:**
A Spinoza-type trajectory assumes that nature is understood as a **necessary order**, intelligible “in itself,” and not as a simple **renewed decree**. Acharism does not eliminate all rationality, but it **degrades** necessity (and thus the metaphysical basis of a radical rationalist critique of religion).
...
**Hanbali-Salafi crystallization (anti-ta’wīl):**
In the **Hanbali** tradition and later in the works of **Ibn Taymiyyah** (d. 1328), we see a more direct criticism of allegorical *ta’wīl*: priority is given to the apparent meaning, to tradition, and to the avoidance of speculative constructions perceived as imported. Even if Ibn Taymiyyah does not exhaust Sunnism, his modern influence (Salafism) accentuates **distrust** of philosophical symbolic interpretation.

**Challenge for “Maimonides → Spinoza”:** 
Spinoza, in a modern register, assumes a hermeneutic in which:

1. the text is historically situated,

2. the plurality of meanings is controlled by a critical method,

3. religious authority loses its monopoly. 
However, in the majority Sunni configuration, polysemy tends to be **re-closed** in order to preserve doctrinal and legal unity.
...
**Challenge for “Maimonides → Spinoza”:**
Maimonides carried out an internal rationalization of the Law (philosophy as a method). Spinoza crossed an additional threshold: philosophy became the **sovereign authority** for judging nature, Scripture, and politics.
...
1. ***preserved** (translations, commentaries, canonization);*

2. ***radicalized** (gradual desacralization of religious authority);*

3. ***secularized** (transfer of normativity to politics and science).*
