---
title: "Une histoire des lectures : la racine K-P-R à travers les traditions"
lang: fr
...
L'article précédent du dossier, *La racine du recouvrement*, a établi la structure synchronique de la racine *k-p-r / k-f-r* : un noyau gestuel unique, sept pôles attestés, une triple polarité conservée jusque dans le canon coranique. Cet article second engage la *diachronie*. Il reconstitue, couche par couche, comment chaque grande tradition héritière du fonds sémitique antique a *reçu, retravaillé et redéployé* l'opérateur — depuis l'akkadien du IIe millénaire avant notre ère jusqu'au seuil de la modernité (XVIIIe siècle).

L'enjeu de cette généalogie est de mettre en évidence un fait massif et trop souvent oublié : **aucune tradition pré-moderne n'a réduit la racine à un seul de ses pôles**. Toutes — rabbinique, chrétienne, soufie, falsafienne, classique sunnite, classique shīʿite — ont pratiqué une *retenue* sur l'usage polémique du *kufr*, et ont conservé en leur cœur le pôle expiatoire et miséricordieux. Le maximalisme khārijite, qui apparaît dès la première fitna (656-661), est l'exception explicitement désavouée par toute la grande tradition.

Cette donnée est cruciale pour comprendre la rupture moderne, dont l'article 3 du dossier fera l'archéologie. Avant la rupture, il faut établir avec soin ce qui *tenait*. C'est l'objet du présent article.
...
## 6. Strate arabe pré-islamique (VIe s. EC) {#s6}

L'article 1 a déjà établi le sens neutre-positif dominant de la racine *k-f-r* en arabe pré-coranique. On rappelle l'essentiel :
...
## 8. Strate du *kalām* classique (VIIIe-XIIe s.) {#s8}
...
Ghazālī (m. 1111), dans son *Faysal al-tafriqa bayna al-īmān wa-l-zandaqa*, écrit la grande défense méthodologique :
...
> *« Dieu se manifeste dans toutes les croyances, et celui qui restreint sa croyance à une seule forme rejette les autres formes. »*
...
## 11. Strate du *fiqh* classique (VIIIe-XVe s.) {#s11}

Tandis que la théologie polémique a parfois dérivé vers le *kufr* polémique, le *fiqh* a conservé soigneusement le *kpr* expiatoire. Les manuels classiques (al-Shāfiʿī, *Umm* ; al-Sarakhsī, *Mabsūṭ* ; Ibn Qudāma, *Mughnī* ; al-Ḥillī pour le shīʿisme) consacrent des chapitres entiers aux *kaffārāt* (expiations) :

- *kaffārat al-yamīn* (Q 5, 89) : expiation du serment rompu — nourrir 10 pauvres, ou les vêtir, ou affranchir un esclave, ou jeûner trois jours ;
- *kaffārat al-ẓihār* (Q 58, 3-4) : expiation du serment de répudiation préislamique ;
- *kaffārat al-qatl* (Q 4, 92) : expiation du meurtre involontaire — affranchir un esclave et payer le prix du sang ;
- *kaffārat al-ramaḍān* : expiation de la rupture volontaire du jeûne ;
- *kaffārat al-iḥrām* : expiation des fautes commises pendant le pèlerinage.

Toutes ces *kaffārāt* fonctionnent sur le modèle du *kpr* hébraïque : *interposer un acte (don, jeûne, affranchissement) qui recouvre la faute*. **Le pôle positif de la racine est donc préservé par le droit, là où la théologie l'a parfois oublié.** Tout musulman pratiquant est, dans la pratique, en relation avec ce pôle positif : le mot *takfīr* signifie pour lui, dans la prière et la jurisprudence quotidiennes, *« faire couvrir la faute par Dieu »*. Cette donnée est massivement sous-estimée dans les discussions contemporaines.

---

## 12. Bilan diachronique : ce que la racine a porté avant la modernité {#s12}

À l'issue de ces strates, la racine *k-p-r / k-f-r* se présente, à la veille de la modernité (XVIIIe siècle), comme un *opérateur sémantique d'une rare richesse* :

| Pôle | Tradition principale | Lexèmes-clés |
|---|---|---|
| Matériel | Akkadien, hébreu | *kupru*, *kofer* (bitume) |
| Cultuel-expiatoire (humain → Dieu) | Hébreu sacerdotal, christianisme paulinien | *kapporet*, *kipper*, *hilastērion* |
| Juridique-rançon | Hébreu, droit islamique | *kofer*, *kaffāra* |
| Expiatoire (Dieu → homme) | Coran, soufisme | *takfīr* divin, *yukaffir* |
| Agraire | Pré-islamique, Q 57, 20, parabole synoptique | *al-kuffār* (paysans), *ho speirōn* |
| Mystique paradoxal | Soufisme classique | *kufr* du soi (Hallāj, Ibn ʿArabī) |
| Théologique-polémique | Coran médinois, *kalām* | *kāfir* contre *muʾmin* |
| Anathème inter-musulman | Khārijites (minoritaire), Ibn Taymiyya | *takfīr al-muslim* |
| Sapientiel-éthique | Coran mecquois | *kufr* contre *shukr* |

**Ce qui est crucial.** Aucune tradition pré-moderne n'a jamais réduit la racine à *un seul* de ces pôles. Le *kalām* sunnite classique pratique la retenue ; les *fuqahāʾ* maintiennent le pôle expiatoire ; les soufis inversent dialectiquement ; les philosophes relativisent ; les rabbins, les Pères chrétiens et les commentateurs coraniques tiennent ensemble plusieurs registres.

**La grande question.** Cette pluralité a-t-elle été préservée jusqu'à aujourd'hui ? Elle ne l'a pas été — du moins pas dans l'usage public dominant. C'est l'objet de l'article 3 du dossier que d'établir le tournant qui a transformé, à partir des XVIIIe-XXe siècles, cet opérateur plurivoque en arme univoque.
...
- *BHS* ; *Septuaginta* (Rahlfs) ; *NA28* ; Coran Caire 1924 ; *Mishna* Albeck ; *Talmud Bavli* éd. Vilna et Steinsaltz-Koren ; *Sifra* Finkelstein ; *Pirqei de Rabbi Eliezer* éd. Friedlander, 1916 ; *Bereshit Rabba* Theodor-Albeck.
- Atrahasis : Lambert-Millard, 1969. Gilgamesh : George, 2003. *CAD* vol. K, Chicago, 1971.
- Tabarī, *Jāmiʿ al-bayān* ; Zamakhsharī, *Kashshāf* ; Rāzī, *Mafātīḥ al-ghayb* — pour Q 57, 20.
...
- Averroès, *Faṣl al-maqāl*, trad. Geoffroy, *Discours décisif*, GF Flammarion, 1996.
- Maïmonide, *Guide des Égarés*, trad. Munk, 1856-1866 ; éd. moderne Pines, 1963.
...
- Gardet, Louis, *La pensée religieuse d'Avicenne*, Vrin, 1951.
- Genequand, Charles, *Ibn Rushd*, Brill, 1986.
- Gimaret, Daniel, *La doctrine d'al-Ashʿari*, Cerf, 1990.
- Goldberg, Arnold, *Untersuchungen über die Vorstellung von der Schekhinah*, De Gruyter, 1969.
- Hallaq, Wael, *Sharīʿa: Theory, Practice, Transformations*, Cambridge UP, 2009.
- Hayes, Christine, *What's Divine About Divine Law?*, Princeton UP, 2015.
- Hodgson, Marshall, *The Venture of Islam*, vol. I-II, Chicago UP, 1974.
...
- Massignon, Louis, *La Passion de Husayn ibn Mansūr Hallāj*, 4 vol., Gallimard, 1975 (1re éd. 1922).
...
- Urbach, Ephraim, *Les sages d'Israël*, Cerf, 1996.
- van Ess, Josef, *Theologie und Gesellschaft im 2. und 3. Jahrhundert Hidschra*, 6 vol., De Gruyter, 1991-1997.
