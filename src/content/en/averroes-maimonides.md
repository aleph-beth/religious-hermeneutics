---
title: "Averroes and Maimonides — Cordoba's Philosophy as Foundation of the Enlightenment"
lang: en
...
|---|---|---|
| **Birth** | 1126, Cordoba | 1138, Cordoba |
| **Language of writing** | Arabic | Judeo-Arabic |
| **Religion** | Sunni Islam | Judaism |
| **Profession** | Philosopher, physician, jurist | Philosopher, physician, jurist |
| **Major work** | *Tahafut al-Tahafut* + commentaries on Aristotle | *Moreh Nevukhim* (Guide for the Perplexed) |
| **Central problem** | Reconciling Aristotle and the Quran | Reconciling Aristotle and the Torah |
| **Exile** | Marrakesh (Almohad persecution) | Fostat/Cairo (Almohad persecution) |
| **Death** | 1198, in exile | 1204, in exile |
| **European epithet** | "The Commentator" | "Rabbi Moses" |
...
**Maimonides**: reason is the guide to interpreting Scripture. When the literal meaning of the Torah contradicts demonstrated reason, it is the literal meaning that must be reinterpreted, not reason that must submit.
...
**Maimonides**: **negative theology** — one can only say of God what He is not. God is not a body, is not finite, is not ignorant. Every positive attribute is a limitation, and therefore idolatry.
...
**Maimonides**: the *Guide for the Perplexed* is an interpretive manual that distinguishes literal meaning (*peshat*) from philosophical meaning. The biblical narratives of creation, prophecy, and miracles must be read philosophically, not literally.
...
**Maimonides**: the role of the prophet is political as much as spiritual. The Law is an instrument of rational governance, not only of salvation.
...
```
Averroes (Cordoba, 12th c.)
    -> Latin translations (Toledo, Michael Scot)
        -> Latin Averroism (Siger of Brabant, Paris, 13th c.)
            -> Condemnations of 1277 (proof of massive influence)
                -> Paduan Averroism (Pomponazzi, 16th c.)
                    -> Naturalism, mortality of the soul
                        -> Spinoza (Amsterdam, 17th c.)
                            -> Enlightenment (18th c.)
```

**Paradox**: Averroes, rejected and burned in the Islamic world, becomes *the* philosopher of Christian universities. In 1255, his commentaries on Aristotle are *mandatory* in Paris. Thomas Aquinas writes *against* Averroes — but within the framework that Averroes defined. It is Averroes who sets the terms of the debate.

### Maimonidean lineage: Cordoba -> Provence -> Amsterdam -> Enlightenment

```
Maimonides (Cordoba -> Cairo, 12th c.)
    -> Translation of the Guide into Hebrew (Samuel ibn Tibbon, Provence, 1204)
        -> Maimonidean controversy (13th c.)
            -> Italian Jewish philosophy (15th-16th c.)
                -> Sephardic community of Amsterdam (17th c.)
                    -> Spinoza (library containing the Guide)
                        -> TTP (1670): biblical criticism
                            -> Enlightenment
```
...
|-----------------------|-----------------|---------------------|-------------|
| Autonomy of reason | Averroes: double truth | Latin Averroism, Padua | Kant: *Sapere aude* |
| Non-personal God | Maimonides: negative theology | Italian Jewish philosophy | Spinoza: *Deus sive Natura* |
| Biblical criticism | Maimonides: rational hermeneutics | Sephardic diaspora | Spinoza: TTP (1670) |
| Separation of faith/reason | Averroes: three levels of discourse | Thomas Aquinas (critical heir) | Secularism |
| Religious tolerance | Maimonides + Averroes: plurality of paths | Servetus (martyr), Castellio | Locke, Voltaire |
...
The answer — non-essentialist but historical:

1. **The Jewish diaspora** carries the text. The Jews, a People of the Book without a territory, preserve and transmit through commentary. The manuscripts travel with them.
2. **Islamic centralization** stifles debate. Ash'arite Sunnism, consolidated by the Mamluks and then the Ottomans, marginalizes *falsafa*.
3. **The printing press**: the *Guide for the Perplexed* is printed in 1520 (Rome), then widely distributed. Averroes' commentaries are printed in Venice. The Ottoman world refuses printing in Arabic characters until the 18th century.
4. **Dutch tolerance**: Spinoza can publish the TTP (under a pseudonym) in Amsterdam. No comparable space exists in the Islamic world.
...
- Historical context: [Islam, Europe, and the Mongols: A Chronology of Encounters](../islam-europe-chronology/)
- Mysticism: [The Zohar — Cordoba's Mysticism as Matrix of the European Renaissance](../zohar-cordoba-mysticism/)
- Concealment: [The Concealment of the Debt — How Europe Erased Cordoba From Its Narrative](../debt-concealment/)
