---
title: "Secularism and Islam: The Mutazilite Misunderstanding"
lang: en
...
The argument deserves rigorous analysis. For while the intention is commendable — avoiding the essentialization of a religion practiced by nearly two billion people — the reasoning carries within it a fundamental contradiction that the chronology of Islamic history is sufficient to expose.

The thesis we defend is as follows: Mutazilism is indeed compatible with secularism, because it shares with it the same epistemological foundation. But orthodox Sunnism, which constitutes the majority Islam of today, was constructed historically and theologically *against* that foundation. It is therefore incompatible with secularism not by cultural accident or historical delay, but by doctrinal architecture.
...
Its central theses are revolutionary within the Islamic context:

- **The Quran is created**: inscribed in time, in a language, in a historical context. It is therefore interpretable, contextualizable — and potentially relativizable in its juridical prescriptions.
- **Reason precedes revelation**: *al-ʿaql qabl al-naql*. An act is good or bad independently of what the text says. God himself cannot command injustice, because justice is rationally accessible.
- **Free will is total**: man is responsible for his acts because he has genuinely chosen. This anthropology founds an individual moral subjectivity.
- **Radical Tanzīh**: God is absolutely transcendent. His attributes must be interpreted allegorically, not literally hypostasized.
...
Under Caliph Mutawakkil in 848, the reversal was total and definitive. Mutazilism was officially condemned. Ashʿarism and Māturīdism established themselves as orthodox Sunni theologies. Ibn Ḥanbal founded the tradition that, centuries later, would lead to Wahhabism.
...
After 1258, Islam was in mourning for its own speculative capacity. *Taqlīd* — the imitation of the ancients — henceforth took precedence over *ijtihād* — the effort of interpretation. The gate of ijtihād was progressively closed. Post-1258 Islam is structurally anti-Mutazilite because it is in mourning for its own possible modernity.
...
- **The Quran is uncreated and eternal**: its juridical prescriptions are transcendent, not contingent. Civil law therefore cannot replace them, only administer them.
- **Reason is subordinate to revelation**: ethics does not precede the text. What God commands is just by definition.
...
Apostasy (*ridda*) is juridically sanctioned not because it offends God, but because it breaks the coherence of the community. Individual conscience is not primary — it is derived from collective belonging.
...
The Christian analogy illuminates the weakness of the approach: if someone wanted to defend the compatibility of medieval Christianity with democracy by citing the Cathars or Meister Eckhart, one would rightly respond that Rome burned them. The tradition they cite is precisely the one the institution condemned.
...
This revolution cannot come from outside through legislative or administrative means. It must emerge from within the theological corpus. And for that, the available intellectual substrate — Mutazilism — has been methodically destroyed for twelve centuries by dominant Sunni theology.
...
Mutazilism and orthodox Sunnism are not two nuances of the same system. They do not share the same fundamental epistemology. The first is compatible with a project of secularization because it shares with it the same conditions of possibility: autonomous reason, a historicizable text, individual conscience as primary. The second is structurally resistant to it not by cultural delay or refusal of modernity, but by doctrinal architecture deliberately constructed against those very conditions.

When one says that "Islam is compatible with secularism" without specifying which Islam, one commits an abstraction that erases eight centuries of theological combat. A combat that Sunnism won unambiguously.

Mutazilism is the tomb in which Sunnism buried the possibility of its own secularization.
