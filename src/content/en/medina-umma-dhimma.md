---
title: "The Charter of Medina, I — Before the dhimma: Jews as Members of the umma"
lang: en
...
> "The Jews of the Banū ʿAwf are one community (*umma*) with the believers (*maʿa al-muʾminīn*). To the Jews their *dīn*, to the Muslims their *dīn* — their clients (*mawālī*) as themselves — except whoever does wrong or acts treacherously: he harms only himself and his own household."

The clause is then repeated, almost word for word, for the Jews of the Banū al-Najjār, al-Ḥārith, Sāʿida, Jusham, al-Aws, Thaʿlaba, and other clans. Three elements deserve emphasis:

1. **Membership is explicit**: the Jews are not external allies (*ḥulafāʾ*) or protégés, but members of a common *umma* — or, depending on the textual variant (*umma maʿa* / *umma min*), a community *with* or *of* the believers. On either reading, they are **inside** the pact.
2. **Normative autonomy is guaranteed**: "to the Jews their *dīn*" does not merely mean freedom of worship in the modern sense, but the preservation of their **law** — courts, marriage rules, dietary usages, calendar. *Dīn* (root D-Y-N: obligation, debt, judgment, law) is a complete legal order, not a private piety.
3. **Responsibility is individual**: whoever betrays "harms only himself and his own household." The pact proclaims the principle of non-collective responsibility — a principle which, as Part II of this dossier shows, would not survive the crises, for want of any machinery to enforce it.
...
This distinction, highlighted in particular by Fred Donner's work (*Muhammad and the Believers*, 2010), is not a stylistic detail:
...
| --- | --- | --- |
| Akkadian | *ummu* / *ummatu* | mother / troop, constituted body |
| Hebrew | *ʾummā* (אֻמָּה) | tribe, nation (Gen 25:16; Ps 117:1) |
| Aramaic | *ʾummetā* (אֻמְּתָא) | people, nation (Dan 3:4: "peoples, nations, and languages") |
| Arabic | *umma* (أمّة) | community, nation |
...
*Umma* and *dhimma* thus form a troubling pair: the same morphological pattern, the same central gemination (-mm-), a single consonant apart — yet **two distinct roots** (ʾ-M-M / ḏ-M-M) and, above all, two opposed logics. One passes:

* from the **matrix** to the **claim**;
* from belonging to protection;
* from constitutive partner to subordinate beneficiary;
* from a status defined by what one *is together* to a status defined by what the other party *owes you*.
...
| --- | --- | --- |
| Charter of Medina (622) | Members of the *umma*, their *dīn* guaranteed | Horizontal covenant pact |
| Medinan crises (624–627) | De facto exclusion of the three great tribes | Force, not procedure |
| Conquests and the "Pact of ʿUmar" (7th–8th c.) | *Ahl al-dhimma*: protected in exchange for tribute (*jizya*) | Codified legal subordination |
| Classical law (from the 8th c.) | Permanent differentiated status | The *umma* redefined as confessional |
...
On one side, the Charter of Medina attests an inclusion **without known equivalent** in the late antique world: the Jews are full members of a political community, with an explicit guarantee of their law and customs, no conversion required, in a vocabulary (*muʾminūn*, *umma*) still open and non-confessional.
