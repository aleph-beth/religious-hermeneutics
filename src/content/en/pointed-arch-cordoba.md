---
title: "The Pointed Arch of Cordoba — Islamic Architecture and European Gothic"
lang: en
...
The Mezquita of Cordoba, built in four phases (Abd al-Rahman I, 785 -> al-Mansur, 987), is a laboratory of architectural innovation without parallel in Western Europe at that time:

| Innovation | Date | Description | Precedence over Europe |
|-----------|------|-------------|----------------------|
| **Pointed arch** | 785 | Horseshoe arch and pointed polylobed arches | ~300 years before Saint-Denis (1140) |
| **Double superimposed arcade** | 785 | Lower horseshoe arches + upper round arches = height without thick walls | Solution to the height problem that Gothic would solve differently |
| **Alternating stone/brick** | 785 | Alternating red and white voussoirs | Aesthetic adopted in Pisan and Sienese Romanesque |
| **Ribbed vaults** | 961 | Maqsura of al-Hakam II: intersecting cross-ribbed vaults | ~200 years before the Gothic rib vault |
| **Dome on ribs** | 961 | Maqsura domes: ribs that do not cross at the center | Structural principle different from the Byzantine dome, anticipating the Renaissance |
| **Modularity** | 785-987 | Extendable in all directions (forest of columns) | Concept of an extensible plan absent from Romanesque architecture |

### The crucial point: the ribbed vaults of al-Hakam II (961)
...
|----------|------|-----------------|
| **San Baudelio de Berlanga** | 11th c. | Central pillar and palm arches — a converted mosque |
| **Toledo Cathedral** | 1226+ | Polylobed arches, Mudejar style, Muslim master builders |
| **Alcazar of Seville** | 14th c. | Peter I of Castile calls on Nasrid artisans |
| **Mudejar style** | 12th-16th c. | An entirely Islamic style practiced by Muslims under Christian rule |
...
| Argument | Detail |
|----------|--------|
| **Chronology** | The pointed arch appears in Islam (8th c.) before Europe (12th c.) |
| **Ribbed vaults** | Cordoba (961) -> Durham (1093) -> Saint-Denis (1140): the chronological sequence is clear |
| **Geography** | The earliest Gothic appears in zones of contact with Islam (Norman Sicily, Spain, Crusades) |
| **Mudejar** | Direct proof of Muslim artisans building for Christians |
| **Technical convergence** | It is not a single element but a *system* (pointed arch + ribbed vault + structural lightness) that is transmitted |

### Against transmission

| Argument | Detail |
|----------|--------|
| **Independent invention** | The pointed arch is a logical structural solution that multiple civilizations could find independently |
| **Different function** | The Islamic pointed arch is often decorative; the Gothic pointed arch is structural |
| **Gothic complexity** | The Gothic system (flying buttress, buttress, rose window) is a unique ensemble without Islamic equivalent |
| **Lack of documentation** | No medieval text explicitly documents "we learned this from the Saracens" |
...
| Region | Examples | UNESCO status |
|--------|----------|---------------|
| **Aragon** | Towers of Teruel, Aljaferia of Zaragoza | World Heritage (1986, 2001) |
| **Castile** | Synagogue del Transito (Toledo), Alcazar of Seville | World Heritage |
| **Andalusia** | Alhambra of Granada | World Heritage (1984) |
| **Portugal** | Manueline style (Mudejar + late Gothic synthesis) | - |
...
When the British built neo-Gothic buildings in India and Egypt, they carried the descendants of the pointed arch of Cordoba into the very world that had invented it.
