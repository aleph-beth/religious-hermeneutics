---
title: "L'arc brisé de Cordoue — L'architecture islamique et le gothique européen"
lang: fr
...
La Mezquita de Cordoue, construite en quatre phases (Abd al-Rahman Ier, 785 → al-Mansur, 987), est un laboratoire d'innovation architecturale sans équivalent en Europe occidentale à cette époque :

| Innovation | Date | Description | Antériorité sur l'Europe |
|-----------|------|-------------|------------------------|
| **Arc brisé** | 785 | Arc en fer à cheval outrepassé et arcs brisés polylobés | ~300 ans avant Saint-Denis (1140) |
| **Double arcature superposée** | 785 | Arcs inférieurs en fer à cheval + arcs supérieurs en plein cintre = hauteur sans murs épais | Solution au problème de la hauteur que le gothique résoudra autrement |
| **Alternance pierre/brique** | 785 | Claveaux alternés rouges et blancs | Esthétique reprise dans le roman pisan et siennois |
| **Voûtes nervurées** | 961 | Maqsura d'al-Hakam II : voûtes à nervures croisées entrecroisées | ~200 ans avant la croisée d'ogives gothique |
| **Coupole sur nervures** | 961 | Coupoles de la maqsura : nervures qui ne se croisent pas au centre | Principe structurel différent de la coupole byzantine, anticipant la Renaissance |
| **Modularité** | 785-987 | Extension possible dans toutes les directions (forêt de colonnes) | Concept de plan extensible absent de l'architecture romane |

### Le point crucial : les voûtes nervurées d'al-Hakam II (961)
...
|----------|------|-------------------|
| **San Baudelio de Berlanga** | XIe s. | Pilier central et arcs en palmier — mosquée transformée |
| **Cathédrale de Tolède** | 1226+ | Arcs polylobés, mudejar, maîtres d'oeuvre musulmans |
| **Alcazar de Séville** | XIVe s. | Pierre Ier de Castille fait appel à des artisans nasrides |
| **Style mudéjar** | XIIe-XVIe s. | Style entièrement islamique pratiqué par des musulmans sous domination chrétienne |
...
| Argument | Détail |
|----------|--------|
| **Chronologie** | L'arc brisé apparaît en Islam (VIIIe s.) avant l'Europe (XIIe s.) |
| **Voûtes nervurées** | Cordoue (961) → Durham (1093) → Saint-Denis (1140) : la séquence chronologique est claire |
| **Géographie** | Le premier gothique apparaît dans les zones de contact avec l'Islam (Sicile normande, Espagne, Croisades) |
| **Mudéjar** | Preuve directe d'artisans musulmans construisant pour des chrétiens |
| **Convergence technique** | Ce n'est pas un seul élément mais un *système* (arc brisé + voûte nervurée + légèreté structurelle) qui est transmis |

### Contre la transmission

| Argument | Détail |
|----------|--------|
| **Invention indépendante** | L'arc brisé est une solution structurelle logique que plusieurs civilisations peuvent trouver indépendamment |
| **Fonction différente** | L'arc brisé islamique est souvent décoratif, l'arc brisé gothique est structurel |
| **Complexité du gothique** | Le système gothique (arc-boutant, contrefort, rosace) est un ensemble unique sans équivalent islamique |
| **Manque de documentation** | Pas de texte médiéval qui documente explicitement "nous avons appris cela des Sarrasins" |
...
| Région | Exemples | Statut UNESCO |
|--------|----------|---------------|
| **Aragon** | Tours de Teruel, Aljafería de Saragosse | Patrimoine mondial (1986, 2001) |
| **Castille** | Synagogue del Tránsito (Tolède), Alcazar de Séville | Patrimoine mondial |
| **Andalousie** | Alhambra de Grenade | Patrimoine mondial (1984) |
| **Portugal** | Style manuélin (synthèse mudéjar + gothique tardif) | - |
...
Quand les Britanniques construisent des bâtiments néogothiques en Inde et en Égypte, ils transportent les descendants de l'arc brisé de Cordoue dans le monde qui l'a inventé.
