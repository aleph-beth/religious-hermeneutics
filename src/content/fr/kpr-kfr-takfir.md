---
title: "Le retournement contemporain : la modernité du takfīr étendu"
lang: fr
pair: kpr-kfr-takfir
category: etymology
...
>
> 1. Ne pas confondre *l'islam* avec *l'islamisme jihadiste*. La majorité des musulmans dans le monde ne pratiquent pas le *takfīr* étendu et n'utilisent pas le mot *kāfir* dans le registre polémique radical étudié ici.
>
...
Les articles précédents du dossier ont établi que la racine sémitique *k-p-r / k-f-r* est, à la veille de la modernité, un opérateur d'une grande richesse : sept registres concurrents, tenus ensemble par toutes les grandes traditions héritières (rabbinique, chrétienne, islamique classique, soufie, falsafienne). La retenue dans l'usage du *takfīr* est la *règle* dans le sunnisme classique ; le maximalisme khārijite est l'*exception* explicitement dénoncée par les grands théologiens.

**Or l'usage contemporain dominant — dans l'espace médiatique, dans les réseaux jihadistes, dans la polémique inter-musulmane et dans la perception occidentale — a presque entièrement réduit la racine à *un seul* de ses pôles : le pôle polémique négatif.** Le mot *kāfir* est devenu, dans une part importante du discours islamique mondialisé, un mot *d'anathème étendu*, parfois prononçable contre des musulmans eux-mêmes, et systématiquement contre les non-musulmans.

Cet article reconstitue **l'histoire courte (XIVe-XXIe siècles)** de cette réduction. Il ne prétend pas représenter l'islam dans son ensemble — la majorité des musulmans pratiquants n'utilisent pas le mot *kāfir* dans ce registre polémique radical, et de nombreux courants reformistes, soufis, traditionnels modérés et académiques en récusent l'usage. Il documente comment **une minorité doctrinale a, en quelques siècles, capté l'usage public de la racine**, au détriment de sa profondeur historique.
...
- *takfīr al-nawʿ* : qualifier *un type d'acte* (par exemple, refuser d'appliquer la Sharīʿa) comme relevant du *kufr* en abstraction ;
- *takfīr al-muʿayyan* : qualifier *un individu déterminé* comme *kāfir*.

**Il n'autorise pas le second sans procédure rigoureuse**, sans établissement des conditions (*shurūṭ*) et sans vérification de l'absence d'empêchements (*mawāniʿ*). Sa lecture est *plus restrictive* que celle des jihadistes contemporains.

Mais le ton polémique de ses écrits, sa critique acerbe du soufisme spéculatif (*Risāla fī al-Tawassul wa-l-Wasīla*), du shīʿisme imamite (*Minhāj al-Sunna*) et du falsafisme, ouvrent un *espace discursif* où le *takfīr* redevient pensable. Le tournant néo-hanbalite qu'il porte va polémiquer contre toute lecture allégorique du Coran. Son disciple Ibn Qayyim al-Jawziyya (m. 1350) prolonge le courant.
...
- *tawḥīd al-rubūbiyya* (unicité de la seigneurie) ;
- *tawḥīd al-ulūhiyya* (unicité de l'adoration) ;
- *tawḥīd al-asmāʾ wa-l-ṣifāt* (unicité des noms et attributs).
...
Cette inversion est, philosophiquement et théologiquement, *sans précédent dans la tradition*. Aucun théologien classique sunnite — pas même Ibn Taymiyya — n'a tenu cette position. Quṭb représente une rupture *interne* à la pensée islamique.
...
Daesh ne représente pas l'islam mondial. Il en représente une *fraction militante minoritaire*, dont l'amplification médiatique a faussé la perception extérieure (et parfois interne).
...
- les non-musulmans (juifs, chrétiens, hindous, bouddhistes, athées) ;
- les musulmans accusés de pratiques hétérodoxes (soufis, shīʿites, ahmadis, alaouites) ;
- les musulmans accusés de tiédeur, de modernisme, ou de complaisance envers l'Occident.
...
**ʿAbdolkarim Soroush** (Iran, né 1945), dans *Reason, Freedom, and Democracy in Islam* (2000), distingue le *Coran-message* (universel) du *Coran-discours* (situé). Le *takfīr* relève du second, non du premier. Persécuté par le régime iranien.
...
Le sunnisme académique mainstream (al-Azhar du Caire, Zaytūna de Tunis, Qarawiyyīn de Fès, Deobandi modéré) maintient la *retenue classique sur le takfīr*. **La déclaration d'Amman** (Jordanie, 2005), signée par 552 ulémas de 84 pays, condamne explicitement le *takfīr* extensif et reconnaît la légitimité de huit écoles juridiques (incluant ja'farī shīʿite et ibāḍī) et du soufisme. Ce document constitue un *désaveu collectif* de la doctrine takfīrī par l'autorité religieuse mainstream.

---

## 8. Bilan synthétique : la rupture moderne {#s8}

Si l'on regarde la racine *k-f-r* dans la longue durée (du XVIIIe siècle av. J.-C. — Atrahasis — au XXIe siècle), et qu'on isole les *trois derniers siècles*, on observe une transformation **statistiquement, doctrinalement et discursivement sans précédent** :

**Sur le plan statistique.** Le mot *kāfir* dans le discours public musulman des XIXe-XXIe siècles est *quantitativement écrasé* par son usage polémique négatif. Les usages classiques (paysan, expiation, geste protecteur, pôle dialectique) deviennent inaudibles dans l'espace public, conservés seulement dans les commentaires académiques et la pratique soufie.

**Sur le plan doctrinal.** Le *takfīr* est passé du statut d'*exception réservée* (Ghazālī) au statut de *catégorie applicable à des populations entières* (Quṭb, Daesh). Cette extension est une *rupture* avec le sunnisme classique.

**Sur le plan discursif.** Le mot a été capté par une *rhétorique d'identification-sécession* (*« nous, les vrais croyants, contre eux, les *kuffār* »*), structure inverse de la rhétorique coranique mecquoise (où le *kufr* est un état dont chacun peut sortir par le *shukr* et l'*īmān*).

**Sur le plan herméneutique.** La pluralité des registres (matériel, cultuel, juridique, mystique, agraire, expiatoire) a été aplatie. L'opérateur sémantique pluriel est devenu une *étiquette univoque*. La langue elle-même s'est appauvrie.

**Conclusion.** L'usage contemporain dominant du mot *kāfir* — celui qui circule dans les médias, dans certains réseaux militants, dans la pédagogie de groupes minoritaires mais bruyants — n'est *pas la voix de la tradition islamique* dans son ampleur. C'est une *innovation moderne* (XVIIIe-XXe siècle) qui s'est instituée au prix d'une rupture avec :

- l'arabe pré-islamique (qui connaissait le *kāfir* neutre-positif) ;
- le Coran lui-même (qui préserve les trois polarités) ;
- le *kalām* sunnite classique (qui appelle à la retenue) ;
- la jurisprudence islamique (qui maintient le pôle expiatoire) ;
- la mystique soufie (qui inverse dialectiquement la racine) ;
- la *falsafa* (qui relativise la catégorie) ;
- les traditions sœurs (judaïsme, christianisme) qui partagent la même racine sémitique.

**Cette rupture n'est pas hellénique, n'est pas occidentale, n'est pas externe à l'islam.** Elle est *interne à l'islam moderne*, et sa critique n'a donc pas besoin de venir du dehors : elle peut s'effectuer à partir de la mémoire profonde de la racine elle-même, par les ressources de la philologie, de la théologie classique et de la lecture comparative.

---

## 9. Grille en quatre questions pour analyser un usage contemporain {#s9}

Pour fixer une grille pratique, on propose ce protocole en quatre questions à appliquer à toute occurrence contemporaine du mot *kāfir* :

**(a) De quelle tradition discursive provient cet usage ?** Sunnisme classique ? Wahhabisme XVIIIe ? Quṭbisme XXe ? Jihadisme contemporain ? Soufisme ? Académique ? Médiatique vulgarisé ?

**(b) Quel pôle sémantique est mobilisé ?** Recouvrement matériel ? Expiation ? Ingratitude ? Dénégation ? Anathème social ? Étiquette polémique ?

**(c) Le locuteur est-il conscient de la pluralité historique de la racine, ou la réduit-il à un sens unique ?**

**(d) L'usage est-il en *continuité* avec la tradition classique majoritaire (réticence sur le *takfīr*, conservation du pôle expiatoire), ou en *rupture* (extension takfīrī, polémique anti-musulmane) ?**

Cette grille permet de *localiser* un discours sans le confondre avec *« l'islam »*. Elle évite l'essentialisation tant côté apologétique que côté islamophobe.

---

## 10. Bibliographie {#s10}

### Sur Ibn Taymiyya et son héritage
...
- Rapoport, Yossef et Ahmed, Shahab (éd.), *Ibn Taymiyya and His Times*, Oxford UP, 2010.

### Sur le wahhabisme et le salafisme
...
- Meijer, Roel (éd.), *Global Salafism: Islam's New Religious Movement*, Hurst, 2009.

### Sur l'islamisme et le jihadisme
...
- Khatab, Sayed, *The Power of Sovereignty: The Political and Ideological Philosophy of Sayyid Qutb*, Routledge, 2006.
...
### Sur les voies critiques contemporaines
...
### Sur les dynamiques contemporaines

- Roy, Olivier, *L'islam mondialisé*, Le Seuil, 2002.
- Roy, Olivier, *La sainte ignorance : le temps de la religion sans culture*, Le Seuil, 2008.
